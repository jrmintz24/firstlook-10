// IMPROVED iHomeFinder Property Extractor
// Install this in your iHomeFinder control panel > Custom Code section
...
(function(){
  ...
  function extractPropertyType() {
    ...
    if (bodyText.includes('single family')) return 'Single Family';
    if (bodyText.includes('condominium') || bodyText.includes('condo')) return 'Condo';
    if (bodyText.includes('townhouse')) return 'Townhouse';
    if (bodyText.includes('multi-family')) return 'Multi-Family';
  ...
  function sendToBackend(propertyData) {
    try {
      ...
      fetch('https://uugchegukcccuqpcsqhl.supabase.co/functions/v1/upsert-idx-property', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InV1Z2NoZWd1a2NjY3VxcGNzcWhsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjE1MTM2MzgsImV4cCI6MjAzNzA4OTYzOH0.BsNjB6fSMl4TJ42IxrN-zJjZUbOgTGAR-5YZ2TK0CQY'
        },
      ...
      .catch(function(error) {
        console.error('❌ [Enhanced IHF] Backend error:', error);
      });
