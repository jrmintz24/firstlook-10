-- SAFE DATABASE SETUP FOR SOCIAL FEEDBACK SYSTEM
-- This script checks existing policies and only adds what's needed
...
BEGIN
    ...
    -- Policy for updating own insights
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'buyer_insights' 
