    ...
    <div className="py-16 sm:py-20 bg-white">
      <div className="container mx-auto px-6 sm:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center p-8 bg-red-50/50 rounded-2xl border border-red-100">
            <AlertTriangle className="h-12 w-12 text-red-600 mx-auto mb-6" />
            <h3 className="text-lg font-medium text-gray-900 mb-4">The Old Way</h3>
            <div className="text-gray-600 leading-relaxed font-light space-y-2 text-sm">
          ...
          <div className="text-center p-8 bg-blue-50/50 rounded-2xl border border-blue-100">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-4">The New Rules</h3>
            <div className="text-gray-600 leading-relaxed font-light space-y-2 text-sm">
          ...
          <div className="text-center p-8 bg-green-50/50 rounded-2xl border border-green-100">
            <Zap className="h-12 w-12 text-green-600 mx-auto mb-6" />
            <h3 className="text-lg font-medium text-gray-900 mb-4">The FirstLook Way</h3>
            <div className="text-gray-600 leading-relaxed font-light space-y-2 text-sm">
