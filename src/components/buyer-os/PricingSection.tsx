      ...
      <div className="container mx-auto px-4">
        ...
        {!showOfferServices ? (
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Free Plan */}
            <Card className="border-2 border-gray-200/50 shadow-soft hover:shadow-soft-lg relative overflow-hidden bg-white/95 backdrop-blur-sm">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {offerServices.map((service, index) => (
                <Card key={index} className={`border-2 shadow-soft hover:shadow-soft-lg relative overflow-hidden bg-white/95 backdrop-blur-sm ${
        ...
        <div className="mt-20 text-center">
          <div className="bg-white/90 backdrop-blur-lg border border-gray-200/50 rounded-3xl p-8 max-w-4xl mx-auto shadow-soft hover:shadow-soft-lg transition-all duration-300">
