    ...
    <div className="py-24 relative overflow-hidden bg-white">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          <span className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-8 block">
            FirstLook
          </span>
          
          <h2 className="text-3xl md:text-4xl font-light text-gray-600 mb-6 leading-relaxed tracking-tight">
