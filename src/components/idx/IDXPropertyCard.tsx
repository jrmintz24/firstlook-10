...
export const IDXPropertyCard = ({ 
  property, 
  onScheduleTour, 
  onViewDetails,
  isIDXSource = true 
}: IDXPropertyCardProps) => {
    ...
    <Card className="group cursor-pointer hover:shadow-lg transition-all duration-200 border-gray-200 overflow-hidden">
      <div onClick={handleViewDetails} className="relative">
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          {/* IDX Source Badge */}
          {isIDXSource && (
            <Badge variant="secondary" className="absolute top-3 right-3 bg-blue-100 text-blue-700">
              IDX
            </Badge>
          )}
          ...
          {property.mls.daysOnMarket && (
            <Badge variant="secondary" className="absolute bottom-3 right-3 bg-white/90 text-gray-700">
