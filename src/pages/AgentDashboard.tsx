...
import { useStableAgentDashboard } from "@/hooks/useStableAgentDashboard";
import { useMessages } from "@/hooks/useMessages";
import { useIsMobile } from "@/hooks/use-mobile";
import { useAgentConfirmation } from "@/hooks/useAgentConfirmation";
import ErrorBoundary from "@/components/ErrorBoundary";
import StableLoadingState from "@/components/dashboard/shared/StableLoadingState";
...
const AgentDashboard = () => {
  ...
  console.log('StableAgentDashboard - Current user:', currentUser?.id);
  console.log('StableAgentDashboard - Loading states:', { loading, authLoading, hasError });
  console.log('StableAgentDashboard - Connection status:', connectionStatus);
  ...
  const handleStatusUpdateSuccess = async (requestId: string, newStatus: string, estimatedDate?: string) => {
  ...
  // Wrap everything in error boundary and stable loading
  const content = (
    <StableLoadingState 
