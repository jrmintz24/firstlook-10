...
import { useSimplifiedBuyerDashboardLogic } from "@/hooks/useSimplifiedBuyerDashboardLogic";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-4">
        <div className="text-center">
          <div className="text-lg mb-4 text-red-600">Error loading dashboard</div>
